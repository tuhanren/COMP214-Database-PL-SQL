...
#
# Do NOT modify the method headers.
#
...
class Employee:
    ...
    === Private attributes ===
    _tot_payment: the total up-to-date payment for a employee
    """
    id_: int
    name: str
    _tot_payment: float
...
class Company:
    ...
    def total_payroll(self) -> float:
        ...
        600.25
        """
        tot_payroll_temp = 0.0
        for employee in self.employees:
            tot_payroll_temp += employee.total_pay()
        return tot_payroll_temp
