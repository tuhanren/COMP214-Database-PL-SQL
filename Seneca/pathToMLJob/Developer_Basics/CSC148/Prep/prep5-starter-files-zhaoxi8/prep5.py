...
class LinkedList:
    ...
    # You should uset the provided *linked list traversal* code template
...
# TODO: Make sure you address the task in prep5_starter_tests.py!
#       In that task, you will be writing test cases for __contains__
