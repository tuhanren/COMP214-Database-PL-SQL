...
Create a block using an IF statement to perform the actions described in the above flowchart. 
Use a scalar variable for the total purchase amount and initialize this variable to different values to test your block.
*/
--SET SERVEROUTPUT ON
--DECLARE
--    amount NUMBER(9,2):=&amount;
--    rating VARCHAR2(4);
--BEGIN
--    IF amount > 200
--        THEN rating := 'HIGH';
...
--        rating := 'LOW';
--    END IF;
--    DBMS_OUTPUT.PUT_LINE('Customer rating is: ' || rating);
--END;
